...
export default () => {
		...
		<Footer>
			<Container>
				<Box justifyContent="center" display="flex" mb={8}>
					<Typography fontSize={24} fontFamily="Minecraft" mb={2}>
						wwrpg.aesten.net
					</Typography>
				</Box>
	...
	// 	<Footer>
	// 		<Container>
	// 			<Content direction="row" gap={10}>
	// 				<Stack justifyContent="space-between">
	// <Stack>
	// 	<Typography fontSize={20} fontFamily="Minecraft" mb={2}>
	// 		About
	// 	</Typography>
	// 	In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the form
